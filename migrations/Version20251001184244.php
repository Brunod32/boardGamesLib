 ...
 */
final class Version20251001184244 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE nb_player (id INT AUTO_INCREMENT NOT NULL, min_players SMALLINT NOT NULL, max_players SMALLINT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
